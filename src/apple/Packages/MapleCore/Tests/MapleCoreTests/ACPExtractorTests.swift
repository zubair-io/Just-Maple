...
struct ACPExtractorTests {
    let event=Event(type:"message.received",source:Source(connector:"gmail",account:"test",externalID:"1",revision:"1"),occurredAt:Date(),subjects:["person:self"],content:"Direction: incoming\nBody:\nPlease send your resume by Friday.")
